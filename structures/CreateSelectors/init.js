...
const filePath = aptugo.join(aptugo.apps._getAppDropsFolder(Parameters.app),`${assetId}_${existing.name}`)
aptugo.writeFile(filePath, mainAccumulator, { pretify: false })
